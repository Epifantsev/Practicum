...
func RunningSpentCalories(action int, weight, duration float64) float64 {
	...
	totalSpentCalories := ((runningCaloriesMeanSpeedMultiplier * averageSpeed * runningCaloriesMeanSpeedShift) * weight / mInKm * duration * minInH)
...
func WalkingSpentCalories(action int, duration, weight, height float64) float64 {
	...
	averageSpeedInMsec := averageSpeed * kmhInMsec
	averageSpeedInMsecPow := math.Pow(averageSpeedInMsec, 2)
	totalSpentCalories := ((walkingCaloriesWeightMultiplier*weight + (averageSpeedInMsecPow/heightInM)*walkingSpeedHeightMultiplier*weight) * duration * minInH)
	return totalSpentCalories
}
...
func SwimmingSpentCalories(lengthPool, countPool int, duration, weight float64) float64 {
	...
	totalSpentCalories := (averageSpeed + swimmingCaloriesMeanSpeedShift) * 2 * weight * duration
	return totalSpentCalories
}
